...
DEFAULT_SCREENS = [
    ...
    ("Dashboard", "/dashboard", "Dashboard", ["DEVELOPER", "GP_ADMIN", "OPERATIONS_MANAGER", "PROPERTY_MANAGER", "INVESTOR"]),
    ("Investment", "/investment", "LP Funds", ["DEVELOPER", "GP_ADMIN"]),
    ("Investment", "/investors", "Investors", ["DEVELOPER", "GP_ADMIN", "INVESTOR"]),
    ("Investment", "/investor-onboarding", "CRM & Onboarding", ["DEVELOPER", "GP_ADMIN"]),
    ("Investment", "/pipeline", "My Pipeline", ["DEVELOPER", "GP_ADMIN"]),
    ("Portfolio", "/portfolio", "Properties", ["DEVELOPER", "GP_ADMIN", "PROPERTY_MANAGER"]),
    ("Portfolio", "/area-research", "Area Research", ["DEVELOPER", "GP_ADMIN"]),
    ("Portfolio", "/lifecycle", "Lifecycle", ["DEVELOPER", "GP_ADMIN", "PROPERTY_MANAGER"]),
    ("Portfolio", "/analytics", "Portfolio Analytics", ["DEVELOPER", "GP_ADMIN"]),
    ("Portfolio", "/lp-comparison", "LP Comparison", ["DEVELOPER", "GP_ADMIN"]),
    ("Portfolio", "/trends", "Trends", ["DEVELOPER", "GP_ADMIN"]),
    ("Operations", "/communities", "Communities", ["DEVELOPER", "GP_ADMIN", "OPERATIONS_MANAGER", "PROPERTY_MANAGER"]),
    ...
    ("Finance", "/debt-maturity", "Debt Maturity", ["DEVELOPER", "GP_ADMIN"]),
    ("Reports", "/reports", "Reports", ["DEVELOPER", "GP_ADMIN", "OPERATIONS_MANAGER"]),
    ("Reports", "/quarterly-reports", "Quarterly Reports", ["DEVELOPER", "GP_ADMIN", "INVESTOR"]),
...
ALL_ROLES = ["DEVELOPER", "GP_ADMIN", "OPERATIONS_MANAGER", "PROPERTY_MANAGER", "INVESTOR"]
